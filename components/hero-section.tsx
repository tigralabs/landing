      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 items-center">
          ...
          >
            ...
            >
              <span className="text-primary">BOOST</span> OF YOUR BUSINESS
              OPERATIONS
            </motion.h1>
            <motion.p
            ...
            >
              TigraLabs delivers cutting-edge IT services, outsourcing
              solutions, digital transformation, and automation to help your
